        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a href="visitor.html" ><span> <i class="fas fa-users"></i> </span><span class="hide-menu">Visitor</span></a></li>
                    <li> <a href="course.html" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Course</span></a></li>
                </ul>
            </nav>
        </div>
    </aside>
